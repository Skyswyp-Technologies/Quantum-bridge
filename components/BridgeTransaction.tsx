...
const getTokenSymbol = (tokenId: string) => {
  ...
  const MobileDesign = () => (
    <div className="bg-[#000000] w-full text-white md:hidden flex flex-col h-screen">
      <MobileNav />
      <div className="flex-grow flex flex-col m-2 h-[calc(100vh-64px)] rounded-3xl border border-[#3E4347] relative">
